...
public class KulutController implements ViewController{
	...
	public void asetaKieli() {
		...
		paivamaara.setText(english.getString("paivamaara"));
	...
	public void lisaaKulu() {
		...
		try {
			...
			if(vh.getKieli()) {
				JOptionPane.showConfirmDialog(null, finnish.getString("tyyppiVirhe"), finnish.getString("syottoVirhe"), JOptionPane.ERROR_MESSAGE);
			} else {
				JOptionPane.showConfirmDialog(null, english.getString("tyyppiVirhe"), english.getString("syottoVirhe"), JOptionPane.ERROR_MESSAGE);
			}
		}
		
		initKulut();
		if(vh.getKieli()) {
			budjetti.setText(finnish.getString("jaljella") + String.format("%.2f",budjettiaJaljellaLaskuri()) + " €");
		} else {
			budjetti.setText(english.getString("jaljella") + String.format("%.2f",budjettiaJaljellaLaskuri()) + " €");
		}
		syotaOstos.clear();
		syotaHinta.clear();
		syotaKuvaus.clear();
	...
	public double budjettiaJaljellaLaskuri() {
		...
		if(vh.getKieli()) {
			budjetti.setText(finnish.getString("jaljella") + String.format("%.2f",budjettiaJaljella ) + " €");
		} else {
			budjetti.setText(english.getString("jaljella") + String.format("%.2f",budjettiaJaljella ) + " €");
		}
	...
	public void initSuodatus() {
		...
		if(vh.getKieli()) {
			...
			valitseKuukausi.getItems().add(finnish.getString("kesa"));
			valitseKuukausi.getItems().add(finnish.getString("heina"));
			...
			valitseKuukausi.getItems().add(english.getString("kesa"));
			valitseKuukausi.getItems().add(english.getString("heina"));
