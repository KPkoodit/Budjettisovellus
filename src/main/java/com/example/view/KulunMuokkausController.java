...
public class KulunMuokkausController implements ViewController{
	...
	public void tallennaNimiHintaKuvaus() {
		...
		try {
			...
			if(vh.getKieli()) {
				JOptionPane.showConfirmDialog(null, finnish.getString("numeroVaroitus"), finnish.getString("syottoVirhe"), JOptionPane.ERROR_MESSAGE);
			} else {
				JOptionPane.showConfirmDialog(null, english.getString("numeroVaroitus"), english.getString("syottoVirhe"), JOptionPane.ERROR_MESSAGE);
			}
		} catch (Exception e) {
